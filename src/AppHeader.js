...
import {Bookmarks, People, History, Language} from "@mui/icons-material";
    ...
    <>
      ...
      >
        ...
        <List>
          ...
          <Link to={"/parsingResults"} style={{textDecoration: 'none', color: 'black'}}>
            <ListItem>
              <ListItemButton>
                <ListItemIcon>
                  <History />
                </ListItemIcon>
                <ListItemText primary="Истории парсинга" />
              </ListItemButton>
            </ListItem>
          </Link>
        </List>
